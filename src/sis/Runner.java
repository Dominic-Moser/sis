...
public class Runner {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ArrayList<Student> sClass = fetchStudents.parseResult();
        menuOptions(sClass);
    }
        ...
        if (option == 3) {
            ...
            for (int i = 0; i < sClass.size(); i++) {
                if (sClass.get(i).getLastName().equals(lastName)) {
                    ...
                    System.out.println("Period 1: " + sClass.get(i).getPeriod1() + ", Period 2: "
                            + sClass.get(i).getPeriod2() + ", Period 3: " + sClass.get(i).getPeriod3());
    ...
    private static void sort(ArrayList<Student> sClass) {
        ...
        if (option == 2) {
            ...
            Collections.sort(sClassDupe, new Comparator<Student>() {
                @Override
                public int compare(Student p1, Student p2) {
                    int ageComparison = Double.compare(Double.parseDouble(calculateGPA(p2)),
                            Double.parseDouble(calculateGPA(p1)));
                    if (ageComparison != 0) {
    ...
    private static int getOption() {
        String nextLine = userStringInput.nextLine();
        try {
